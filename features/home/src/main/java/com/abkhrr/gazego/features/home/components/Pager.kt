...
fun DefaultHorizontalPagerIndicator(
    ...
    activeColor: Color = GazegoTheme.colors.white,
    inactiveColor: Color = activeColor.copy(PagerIndicatorInactiveColorAlpha),
    activeIndicatorWidth: Dp = GazegoTheme.spacing.smallMedium,
    indicatorWidth: Dp = GazegoTheme.spacing.extraSmall,
    indicatorHeight: Dp = indicatorWidth,
    spacing: Dp = GazegoTheme.spacing.smallMedium,
